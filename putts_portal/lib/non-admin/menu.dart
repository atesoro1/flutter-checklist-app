...
class NonAdminMenuItems {
  static const home = MenuItem('Home', Icons.people_rounded);
  static const people = MenuItem('People', Icons.people_rounded);
  static const lists = MenuItem('Lists', Icons.people_rounded);
  static const notifications = MenuItem('Notifications', Icons.people_rounded);
  static const logout = MenuItem('Logout', Icons.people_rounded);
...
class _MenuState extends State<Menu> {
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Spacer(),
              ...NonAdminMenuItems.all.map(buildAdminMenuItem).toList(),
              Spacer(flex: 2),
            ],
          ),
        ),
  ...
  Widget buildAdminMenuItem(MenuItem item) => Container(
    color: Colors.black87,
    child: ListTile(
      selectedTileColor: Colors.yellow[400],
      selected: widget.currentAdminMenuItem == item,
      leading: item.name == 'Notifications' ? Container(margin: EdgeInsets.only(left: 5),child: Text('${count}', style: TextStyle(color: Colors.white),)) : Icon(
          item.icon,
          color: Colors.amber,
      ),
      title: Text(
