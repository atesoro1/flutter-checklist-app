...
class AdminListInstanceView extends StatefulWidget {
  const AdminListInstanceView({Key? key}) : super(key: key);

  @override
  _AdminListInstanceViewState createState() => _AdminListInstanceViewState();
}

class _AdminListInstanceViewState extends State<AdminListInstanceView> {
